...
<head>
    ...
    <style>
        ...
        .table {
            ...
            border-radius: 25px;
            /* Add radius to the table */
            overflow: hidden;
            /* Avoid overflow from the corners given the radius */
            border: transparent;
        ...
        @media (max-width: 500px) {
            ...
            .card-body {
                ...
                max-height: 300px;
                /* Batasi maksimum tinggi jika perlu */
                overflow: auto;
                /* Tambahkan overflow jika konten melebihi ketinggian */
            }
        }
    </style>
</head>
        ...
        <div class=" chart-container">
            <div class="row mb-4">
                <div class="col-lg-4">
                    <div class="card shadow-sm">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Data Peminjaman Kategori</h6>
                        </div>
                        <div class="card-body">
                            <div id="chartBukuDiv">
                                {!! $chartBuku->container() !!}
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Data Pembaca</h6>
                        </div>
                        <div class="card-body">
                            <div id="chartBacaDiv">
                                {!! $chartBaca->container() !!}
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Pilih Grafik</h6>
                        </div>
                        <div class="checkbox-container px-3 py-4"> <!-- Tambahkan padding horizontal dan vertikal -->
                            <div class="card-body">
                                <!-- Tambahkan margin bottom -->
                                <!-- Tambahkan padding horizontal dan vertikal -->
                                <h5>Pilih Grafik untuk Diunduh:</h5>
                                <label><input type="checkbox" id="selectPengunjung" checked> Data Pengunjung</label><br>
                                <label><input type="checkbox" id="selectBuku" checked> Data kategori
                                    peminjaman</label><br>
                                <label><input type="checkbox" id="selectBaca" checked> Data Pembaca</label><br>
                                <label><input type="checkbox" id="selectPeminjaman" checked> Data Peminjaman</label><br>
                            </div>
                        </div>
                    </div>
                </div>
