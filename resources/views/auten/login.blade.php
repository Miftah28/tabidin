...
<head>
    ...
    {{-- <link rel="icon" type="image/png" href="{{ asset('img/BUK.jpeg') }}"> <link rel="icon" type="image/png" href="{{ asset('img/favicon.png') }}"> --}}
    <title>
        Login
    </title>
    <!--     Fonts and icons     -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-8 col-12 mx-auto">
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        ...
                        <div class="card-body">
                            <form action="/auten/login" method="post">
                                @csrf
                        ...
                        <div class="text-center mt-3">
                            <p>Belum Registrasi? <a href="/auten/register">Registrasi Sekarang!</p>
                        </div>
                    </div>
                </div>
            </div>
