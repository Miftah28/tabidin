            ...
            <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <button class="btn btn-info"><a href="/kategori/"
                                    style="text-decoration: none; color:white;"><i class="fa-solid fa-circle-info"></i></a></button>
                            <button class="btn btn-warning"><a href="/kategori/edit"
                            ...
                            <button class="btn btn-danger"><a data-toggle="modal"
                                    data-target="#DeleteModal"><i class="fa-solid fa-trash"></i></a></button>
